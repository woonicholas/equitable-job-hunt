    ...
    return(
        <div>
            <Jumbotron>
                ...
                <p className="lead">Job hunting is hard enough without inherent bias. Let *Project Name* help you.</p>
                <hr className="my-2" />
                <p>*Project Name* is revolutionizing the job application system by eliminating factors that could generate bias in the selection process.</p>
                <p className="lead">
                <Button color="primary">Apply Now</Button>
                </p>
            </Jumbotron>
            <Alert color="info" justify="center">
                How can you benefit from using *Project Name*?
            </Alert>
