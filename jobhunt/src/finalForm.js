...
class Jobhunt extends Component{
    ...
    handleSubmit = event => {
        ...
        //alert(`${this.state.name} ${this.state.phone} ${this.state.email} ${this.state.school}
        //${this.state.studies} ${this.state.tools} ${this.state.company} ${this.state.awards}
        //${this.state.cover} ${this.state.linkedin}${this.state.github}${this.state.portfolio}`)
        event.preventDefault()
    }


//const Example = (props) => {
    //specify handler function here
render(){
  return (
      <Container>
